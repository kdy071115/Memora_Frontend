...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-blue-500/10 via-purple-500/10 to-background pt-24 pb-20 md:pt-36 md:pb-28 text-center flex flex-col items-center">
      ...
      <div className="container mx-auto px-4 max-w-screen-xl relative z-10 flex flex-col items-center">
        ...
        <div className="inline-flex items-center rounded-2xl bg-card/60 border border-primary/20 px-4 py-2 text-sm font-bold text-primary shadow-sm backdrop-blur-md mb-8">
          <Sparkles className="mr-2 h-4 w-4" />
          <span>단 하나의 AI 코파일럿</span>
        </div>
        
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight text-foreground leading-[1.2] mb-6">
