      ...
      <div className="container mx-auto px-4 max-w-screen-xl">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
           <div className="text-left max-w-2xl">
             ...
             <p className="mt-4 text-muted-foreground text-lg font-medium">단순한 정보 제공을 넘어, 이해와 기억을 돕는 학습 파트너로 작동합니다.</p>
           </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feat, idx) => (
            <div key={idx} className={`relative overflow-hidden rounded-[2rem] border ${feat.borderColor} ${feat.bgColor} p-10 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group`}>
               ...
               <h3 className="text-2xl font-black mb-3 text-foreground tracking-tight">{feat.title}</h3>
